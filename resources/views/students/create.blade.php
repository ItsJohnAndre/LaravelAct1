...
<header class=max-w-lg mx-auto>
    <a href="#"></a>
        <h1 class="text-4xl font-bold text-indigo-700 text-center" >Add New Student</h1>
</header>
<main class="bg-white max-w-lg mx-auto p-8 my-10 rounded-lg shadow-2xl">

<section class="mt-10">
    <form action="/add/student" class="flex flex-col" method="POST">
        @csrf
        <div class="mb-6 pt-3 rounded bg-gray-200">
            ...
            <input type="text" name="first_name" class="bg-gray-200 rounded
             w-full text-gray-700 focus:outline-none
              border-b-4 border-gray-400 px-3" autocomplete="0" value={{old('first_name')}}>
              @error('first_name')
        ...
        <div class="mb-6 pt-3 rounded bg-gray-200">
            ...
            <input type="text" name="last_name" class="bg-gray-200 rounded
             w-full text-gray-700 focus:outline-none
              border-b-4 border-gray-400 px-3" autocomplete="0" value={{old('last_name')}}>
              @error('last_name')
              <p class="text-red-500 text-xs p-1">
                    {{$message}}
              </p>
        ...
        <div class="mb-6 pt-3 rounded bg-gray-200">
            ...
            <input type="email" name="email" class="bg-gray-200 rounded
             w-full text-gray-700 focus:outline-none
              border-b-4 border-gray-400 px-3" autocomplete="0" value={{old('email')}}>
              @error('email')
              <p class="text-red-500 text-xs p-1">
                    {{$message}}
              </p>
