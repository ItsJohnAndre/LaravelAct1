@include ('partials.header')
    <header class=max-w-lg mx-auto>
        <a href="#">
            <h1 class="text-4xl font-bold text-indigo-700 text-center" >Student Register</h1>
         </a> 
</header>
<main class="bg-white max-w-lg mx-auto p-8 my-10 rounded-lg shadow-2xl">
    <section>
        ...
        <a href="/login" class="text-purple-800 font-bold">here</a></p>
    </section>
    <section class="mt-10">
        <form action="/store" method="POST" class="flex flex-col">
            ...
            <div class="mb-6 pt-3 rounded bg-gray-200">
                ...
                <input type="text" name="name" class="bg-gray-200 rounded
            ...
            <div class="mb-6 pt-3 rounded bg-gray-200">
                ...
                <input type="password" name="password_confirmation" class="bg-gray-200 rounded
                 w-full text-gray-700 focus:outline-none
                  border-b-4 border-gray-400 px-3">
